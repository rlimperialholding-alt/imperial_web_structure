...
import { contracts, customers, leads, projects, tasks } from "@/db/schema";
...
export async function GET(request: Request) {
  try {
    ...
    const [leadRows, taskRows, customerRows, contractRows, projectRows, invoiceRows, importStatus] = await Promise.all([
