...
def reconcile_tracked_secrets(
    ...
    # baseline"; audited-state reconciliations and structurally classified
    # candidates are counted separately, so the message can never overstate
    # how much the protected baseline covers.
