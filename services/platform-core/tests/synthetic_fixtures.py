...
A contract és browserless E2E suite egyaránt innen veszi a hitelesítési
fixture-értékeket, hogy a diffben semmilyen statikus password/token/auth
literál ne szerepeljen (a worker Gate 5 determinisztikus diff-credential
kapuja így 0 találatot ad). A factory valódi credentialt vagy env-secretet
soha nem érint.
"""
