...
from ..models import ConsistencyIssue, EventRecord, ModuleRegistry, OutboxMessage, ProjectRegistry, ReleaseRecord, TaskRecord
...
def dashboard_metrics(db: Session) -> dict:
    ...
    return {
        ...
        "financial_impact_huf": sum((Decimal(str(e.financial_impact_huf or 0)) for e in events), Decimal("0")),
