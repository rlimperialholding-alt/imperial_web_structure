...
const canonicalRoutes = ['/mi-intezzuk/tervezes','/mi-intezzuk/general-kivitelezes','/mi-intezzuk/finanszirozas','/mi-intezzuk/felujitas','/mi-intezzuk/tetoter','/mi-intezzuk/pincebol-lakas','/mi-intezzuk/telek-ellenorzes','/mi-intezzuk/szemelyes-hazajanlas','/biztonsag/vallalasaink','/biztonsag/atlathato-ar','/biztonsag/szerzodes','/biztonsag/projektkovetes','/biztonsag/atadas-utan'];
