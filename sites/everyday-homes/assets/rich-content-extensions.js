  ...
  globalThis.RICH_CONTENT_EXTENSIONS = {
    ...
    "/otthonvalaszto": [
      faqSection("A SZŰRÉS UTÁN FELMERÜLŐ KÉRDÉSEK", [
        ...
        ["Elmenthető a család közös listája?", "A tesztfelület jelenleg tartalmi előnézet. A személyes mentés és az űrlapkezelés majd a későbbi, ellenőrzött ügyfélfelület funkciójából érkezik."],
    ...
    "/elso-lepesek": [
      faqSection("HOGYAN HASZNÁLJÁTOK A TUDÁSTÁRAT?", [
        ...
        ["Elmenthetjük a fontos cikkeket?", "A tesztfelület tartalmi előnézet. A személyes mentési funkció a későbbi, ellenőrzött CMS-megoldás része lehet; addig a címet vagy linket érdemes megőrizni."],
    ...
    "/kezdjuk-egyutt": [
      ...
      faqSection("AZ ELSŐ KAPCSOLATFELVÉTEL GYAKORLATI KÉRDÉSEI", [
        ...
        ["Hogyan kezelik a megadott adatainkat?", "Az éles adatkezelés előtt hozzáférhető, jóváhagyott tájékoztatónak kell bemutatnia a célt, jogalapot, megőrzést, hozzáférést és jogokat. A jelenlegi tesztfelület nem fogad ügyféladatot."],
